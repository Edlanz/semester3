...
-- AddForeignKey
ALTER TABLE `transaction_details` ADD CONSTRAINT `transaction_details_medicine_id_fkey` FOREIGN KEY (`medicine_id`) REFERENCES `medicine`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
